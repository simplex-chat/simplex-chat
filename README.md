...
Base64url encoded string preceding the server address is the server's offline certificate fingerprint. It is generated on server initialization and validated by client during TLS handshake.
