...
privacy blur, and while the full screen viewer covers the chat. The chat list preview (`smallView`) stays a still image. Only GIF reaches this path: desktop decodes
