...
privacy blur, and while a full screen modal covers the chat. The chat list preview (`smallView`) stays a still image. Only GIF reaches this path: desktop decodes
