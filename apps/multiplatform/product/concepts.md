...
| PC27 | Remote Desktop | [README.md](README.md) (Desktop Features) | [spec/architecture.md](../spec/architecture.md), [spec/api.md](../spec/api.md) | `common/.../App.kt`, `common/.../model/ChatModel.kt`, `common/.../model/SimpleXAPI.kt`, `common/.../views/chatlist/ChatListView.kt`, `common/.../views/remote/ConnectDesktopView.kt`, `ConnectMobileView.kt` | `Controller.hs`, `Library/Commands.hs`, `Remote.hs`, `Remote/Types.hs`, `View.hs` |
