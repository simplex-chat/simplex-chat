  ...
  Box(Modifier.fillMaxSize()) {
    Column(
      ...
      SectionView(stringResource(MR.strings.settings_section_title_you)) {
        ...
        SettingsActionItem(painterResource(MR.images.ic_smartphone), stringResource(MR.strings.add_mobile_device), showModal { ConnectMobileView(it) }, disabled = stopped, extraPadding = true)
      }
