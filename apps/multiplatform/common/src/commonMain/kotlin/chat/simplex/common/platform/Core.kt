  ...
  try {
    ...
    if (res != DBMigrationResult.OK) {
      ...
      if (user == null) {
        ...
        appPreferences.onboardingStage.set(
          if (listOf(OnboardingStage.Step1_SimpleXInfo, OnboardingStage.Step2_CreateProfile).contains(savedOnboardingStage) && chatModel.users.size == 1) {
