...
//  }
  ...
  MaterialTheme(
    ...
    shapes = Shapes,
    content = {
      val density = if (appPlatform.isAndroid) LocalDensity.current else Density(LocalDensity.current.density, LocalDensity.current.fontScale * remember { appPrefs.fontScale.state }.value)
