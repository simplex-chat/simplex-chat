...
class AppPreferences {
  ...
  val notificationLEDEnabled = mkBoolPreference(SHARED_PREFS_NOTIFICATION_LED_ENABLED, true)
  ...
  companion object {
    ...
    private const val SHARED_PREFS_NOTIFICATION_LED_ENABLED = "NotificationLEDEnabled"
