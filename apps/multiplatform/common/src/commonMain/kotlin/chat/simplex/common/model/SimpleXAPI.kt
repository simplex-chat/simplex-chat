...
class AppPreferences {
  ...
  val showOneHandUINotice = mkBoolPreference(SHARED_PREFS_SHOW_ONE_HAND_UI_NOTICE, true)
  ...
  companion object {
    ...
    private const val SHARED_PREFS_SHOW_ONE_HAND_UI_NOTICE = "ShowOneHandUINotice"
