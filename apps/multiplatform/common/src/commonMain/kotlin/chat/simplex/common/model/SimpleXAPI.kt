    ...
    when (r) {
      ...
      is CR.NewChatItem -> {
        ...
        if (file != null &&
          ...
          val imageOrVoice = mc is MsgContent.MCImage || mc is MsgContent.MCVoice
          withApi { receiveFile(r.user, file.fileId, encrypted = imageOrVoice && chatController.appPrefs.privacyEncryptLocalFiles.get(), auto = true) }
        }
