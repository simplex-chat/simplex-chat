...
class AppDelegate: NSObject, UIApplicationDelegate {
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey : Any]? = nil) -> Bool {
        ...
        changeAuthDetailsIfReinstalled()
        return true
    }
    ...
    private func changeAuthDetailsIfReinstalled() {
        ...
        if (kcAppPassword.get() != nil || kcSelfDestructPassword.get() != nil) && !UserDefaults.standard.bool(forKey: DEFAULT_PERFORM_LA) && !(hasDatabase() || hasLegacyDatabase()) {
            if kcAppPassword.get() != nil {
                UserDefaults.standard.setValue(true, forKey: DEFAULT_PERFORM_LA)
                privacyLocalAuthModeDefault.set(.passcode)
            }
            if kcSelfDestructPassword.get() != nil {
                UserDefaults.standard.setValue(true, forKey: DEFAULT_LA_SELF_DESTRUCT)
            }
        }
    }
