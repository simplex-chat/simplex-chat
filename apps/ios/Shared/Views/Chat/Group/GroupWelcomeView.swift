...
struct GroupWelcomeView: View {
    ...
    private func textPreview() -> some View {
        messageText(welcomeText, parseSimpleXMarkdown(welcomeText), nil, mentions: nil, groupMembershipId: nil, showSecrets: false, secondaryColor: theme.colors.secondary)
