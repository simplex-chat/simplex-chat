...
struct ContextItemView: View {
    ...
    private func contextMsgPreview(_ contextItem: ChatItem) -> Text {
        return attachment() + messageText(contextItem.text, contextItem.formattedText, nil, preview: true, mentions: nil, groupMembershipId: nil, showSecrets: false, secondaryColor: theme.colors.secondary)
