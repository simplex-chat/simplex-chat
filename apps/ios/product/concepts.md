...
| 27 | Remote Desktop | [views/settings.md](views/settings.md) | [spec/architecture.md](../spec/architecture.md), [spec/state.md](../spec/state.md), [spec/api.md](../spec/api.md), [spec/client/chat-list.md](../spec/client/chat-list.md) | `Shared/SimpleXApp.swift`, `Shared/Model/AppAPITypes.swift`, `Shared/Model/ChatModel.swift`, `Shared/Model/NetworkObserver.swift`, `Shared/Model/RemoteCtrlActivityAttributes.swift`, `Shared/Model/SimpleXAPI.swift`, `Shared/Model/SuspendChat.swift`, `Shared/Views/ChatList/ChatListView.swift`, `Shared/Views/Database/DatabaseView.swift`, `Shared/Views/LocalAuth/LocalAuthView.swift`, `Shared/Views/Migration/MigrateToDevice.swift`, `Shared/Views/RemoteAccess/ConnectDesktopView.swift`, `SimpleX Live Activity/SimpleXLiveActivity.swift` | `Controller.hs`, `Library/Commands.hs`, `Remote.hs`, `Remote/Types.hs`, `View.hs` |
