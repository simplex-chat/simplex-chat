...
| Session management | Manage active desktop control sessions, including while the app is in background | `Shared/Views/RemoteAccess/ConnectDesktopView.swift`, `Shared/Model/SuspendChat.swift` |
