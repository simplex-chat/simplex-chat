...
public enum ChatCommand {
    ...
    public var cmdString: String {
        get {
            ...
            case let .apiCreateGroupLink(groupId): return "/_create_link #\(groupId)"
            case let .apiDeleteGroupLink(groupId): return "/_delete_link #\(groupId)"
            case let .apiGetGroupLink(groupId): return "/_get_link #\(groupId)"
