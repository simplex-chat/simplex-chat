...
public enum ChatCommand {
    ...
    public var cmdString: String {
        get {
            ...
            case let .apiContactQueueInfo(contactId): return "/_qinfo @\(contactId)"
            case let .apiGroupMemberQueueInfo(groupId, groupMemberId): return "/_qinfo #\(groupId) \(groupMemberId)"
