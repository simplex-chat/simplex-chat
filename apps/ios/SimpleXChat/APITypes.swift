...
public enum ChatCommand {
    ...
    public var cmdString: String {
        get {
            ...
            case let .apiAddContact(userId): return "/connect \(userId)"
            case let .apiConnect(userId, connReq): return "/connect \(userId) \(connReq)"
            ...
            case let .apiCreateMyAddress(userId): return "/address \(userId)"
            case let .apiDeleteMyAddress(userId): return "/delete_address \(userId)"
            case let .apiShowMyAddress(userId): return "/show_address \(userId)"
            case let .apiAddressAutoAccept(userId, autoAccept): return "/auto_accept \(userId) \(AutoAccept.cmdString(autoAccept))"
