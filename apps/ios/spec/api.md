...
| `createActiveUser` | `profile: Profile?, pastTimestamp: Bool, keepActiveUser: Bool` | Create new user profile; `keepActiveUser` creates it without activating it | [L17](../Shared/Model/AppAPITypes.swift#L17) |
