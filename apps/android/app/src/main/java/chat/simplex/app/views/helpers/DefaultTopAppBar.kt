...
fun NavigationButtonBack(onButtonClicked: (() -> Unit)?) {
  IconButton(onButtonClicked ?: {}, enabled = onButtonClicked != null) {
    Icon(
      painterResource(R.drawable.ic_arrow_back_ios_new)/*LALAL*/, stringResource(R.string.back), tint = if (onButtonClicked != null) MaterialTheme.colors.primary else HighOrLowlight
    )
  }
}
