{
  ...
  inputs.nixpkgs.url = "github:angerman/nixpkgs?ref=angerman/nixpkgs-unstable-1"; #angerman/nixpkgs/patch-1"; # based on 21.11, still need this, until everything is merged into 21.11.
