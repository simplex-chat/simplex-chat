...
testChatPreferences = Just Preferences {voice = Just Preference {allow = FAYes}, fullDelete = Nothing, receipts = Nothing}

testGroupPreferences :: Maybe GroupPreferences
testGroupPreferences = Just GroupPreferences {voice = Just GroupPreference {enable = FEOn}, fullDelete = Nothing, receipts = Nothing}
