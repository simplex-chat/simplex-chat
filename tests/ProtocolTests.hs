...
testGroupProfile = GroupProfile {displayName = "team", fullName = "Team", description = Nothing, image = Nothing, groupLink = Nothing, groupPreferences = testGroupPreferences}
