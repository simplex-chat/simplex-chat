...
textWithUri = describe "text with Uri" do
  it "correct markdown" do
    ...
    "x.com" <==> uri "x.com"
  it "domains with hyphens" do
    "example-site.org" <==> uri "example-site.org"
    "my-example.com" <==> uri "my-example.com"
    "server-1.example.com" <==> uri "server-1.example.com"
    "multi-word-domain.org" <==> uri "multi-word-domain.org"
    "this is example-site.org" <==> "this is " <> uri "example-site.org"
    "visit my-example.com for details" <==> "visit " <> uri "my-example.com" <> " for details"
    "sub-domain.example-site.com" <==> uri "sub-domain.example-site.com"
    "https://example-site.org" <==> uri "https://example-site.org"
    "https://my-server-1.example.com" <==> uri "https://my-server-1.example.com"
  it "domains with paths" do
    "example.com/path" <==> uri "example.com/path"
    "example.com/path/to/page" <==> uri "example.com/path/to/page"
    "example.com/path/to/page.html" <==> uri "example.com/path/to/page.html"
    "www.example.com/about" <==> uri "www.example.com/about"
    "visit example.com/docs for info" <==> "visit " <> uri "example.com/docs" <> " for info"
    "example-site.org/path" <==> uri "example-site.org/path"
    "example-site.org/path/to/page" <==> uri "example-site.org/path/to/page"
    "https://example.com/path" <==> uri "https://example.com/path"
    "https://github.com/simplex-chat/simplex-chat" <==> uri "https://github.com/simplex-chat/simplex-chat"
    "server-1.example.com/api/v1" <==> uri "server-1.example.com/api/v1"
  it "domains with numeric characters" do
    "server1.example.com" <==> uri "server1.example.com"
    "api2.example.com" <==> uri "api2.example.com"
    "test123.org" <==> uri "test123.org"
    "server1.example.com/path" <==> uri "server1.example.com/path"
  it "ignored as markdown" do
