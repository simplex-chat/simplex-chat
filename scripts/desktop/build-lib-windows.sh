...
echo "    ghc-options: -shared -threaded -optl-L$openssl_windows_style_path -optl-lcrypto-3_0-x64 -o libsimplex.dll libsimplex.dll.def" >> cabal.project.local
...
cp dist-newstyle/openssl-3.0.15/libcrypto-3_0-x64.dll apps/multiplatform/common/src/commonMain/cpp/desktop/libs/$OS-$ARCH/
