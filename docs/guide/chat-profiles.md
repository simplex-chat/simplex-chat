...
4. Tap **+ Add profile**.
5. Create a new profile by inputting your display name and full name (optional).
6. Tap **Create**.
...
To unhide hidden profiles, enter the full password into the search bar.
...
When Incognito mode is toggled on, your current profile name and picture are NOT shared with your new contacts. Instead a new random profile name will be generated for each connection you make with a contact and for each group you join, allowing you to have as many anonymous connections with other people without any shared data between them.

#### To toggle incognito mode on/off:

1. [Open the app settings](./app-settings.md#opening-the-app-settings).
2. Turn on/off incognito mode by toggling the **Incognito** switch.
...
3. Tap **Edit**.
4. Input your desired display name and/or update your full name. You can also change your profile picture.
...
3. Toggle the **Chat is running** switch off to stop chat.(tap "Stop” in the confirmation dialog).
...
4. [Open the app settings](./app-settings.md#opening-the-app-settings).
5. Under the **"Settings"** section, tap **Database passphrase & export**.
6. Toggle the **Chat is running** switch off to stop chat.
7. Tap **Import database**.
8. Select the .zip file of your exported SimpleX Chat data.
9. Tap **Import** in the confirmation dialog.
10. Toggle the **Chat is running** switch on to start the chat or close and restart the app – you will be prompted to enter the passphrase for your chat database.
