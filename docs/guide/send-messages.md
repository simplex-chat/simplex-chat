...
1. Tap 🎙️ (microphone) button on the right of the text area.
2. Allow SimpleX Chat to record your voice if prompted. You will have to tap on the microphone button once again if this happens.
...
**Tip:** You can also tap and hold the 🎙️ (microphone) button to record a voice message. In this case the recording will stop once you release the button. You still need to tap ⬆️ (send) button to send the message.
...
Now you can start typing "live" messages. The app will periodically send updates to your contacts every few seconds as you type only complete words. 
...
- `delete for everyone` - this will either mark the message as deleted for you and your recipient(s) (this is the default) or fully delete the message on your and recipients' devices (if you have enabled "Delete for everyone" in the conversation preferences).
- `delete for me` - this will only delete the message on your device.
