...
Sending text messages on SimpleX Chat is pretty straightforward: tap on your contact and then tap on text area, type in your message and tap ⬆️ (send) button.
...
To send, simply type in the message in the text area and tap ⬆️ (send) button.

To edit or quote a message, tap and hold the message and choose the action.

### Sending images and files

1. Tap 📎 (paperclip) button on the left of the text area.
2. Choose between **Use Camera**, **From Gallery** and **Choose file**.
3. Once you have chosen what you wish to send, tap ⬆️ (send) button.
...
1. Tap 🎤 (microphone) button on the right of the text area.
2. Allow SimpleX Chat to record the voice if prompted. You will have to tap on the microphone button once again if this happens.
3. Speak. Once you've finished recording, tap on the square stop icon on the right.
4. (Optional) You may listen to the recording before sending it, and re-record if necessary.
5. Tap ⬆️ (send) button to send the recorded voice message.
...
**Please note**: If the 🎤 (microphone) button is grayed out, that means voice messages are disabled in this conversation. Ask your contact or group owner to enable them (they are enabled by default).
...
1. Tap on name of the conversation.
2. Toggle the **Disappearing messages** switch on.
...
You can use "live" messages for your recipients to see the messages as you type them, without having to tap ⬆️ (send) button until it's completed. It can be useful in these following scenarios:
...
1. Tap ⚡️ (lightning) button on the right of the text area.
2. When you do it first time, you would see and alert explaining the feature. Tap **OK**, and tap it again.
3. Now you can start typing the messages, the app will be periodically sending the updates to your recipients, as you type (every few seconds, and only complete words).
...
Please read about the reasons for not allowing full deletion by default in [this blog post](../../blog/20221206-simplex-chat-v4.3-voice-messages.md#irreversible-message-deletion) for more details. TL;DR: data sovereignty.
...
Please read about group moderation in [this blog post](../../blog/20230328-simplex-chat-v4-6-hidden-profiles.md#community-moderation) for more details.
