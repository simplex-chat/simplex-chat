...
The sentences: "The badge service refused the renewal: %@" (the service code, e.g. `unknown_purchase_key`); "The badge service did not respond."; "The badge service could not be reached."; "The badge issued by the service cannot be verified."; "Unexpected error: %@".
