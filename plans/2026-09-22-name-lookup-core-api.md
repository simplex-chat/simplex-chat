...
**Not in scope, deliberately.** Registration, renewal and pricing actions — those are #7530, which consumes this API for its own name search rather than duplicating it (§7).
