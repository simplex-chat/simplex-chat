...
import Simplex.Chat.Util (diffInMicros, diffInSeconds, diffInMillis)
...
processChatCommand = \case
  ...
  APIGetChats withPCC -> withUser' $ \user -> do
    void $ timeItM "getChatPreviews" $ withStore' $ \db -> getChatPreviews db user withPCC
    pure CRCmdOk
    -- pure $ CRApiChats chatPreviews
