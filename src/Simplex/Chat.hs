...
createSndMessage chatMsgEvent connOrGroupId = do
  gVar <- asks idsDrg
  withStore $ \st -> createNewMessage st gVar connOrGroupId $ \sharedMsgId ->
...
saveRcvMSG :: ChatMonad m => Connection -> ConnOrGroupId -> MsgMeta -> MsgBody -> m (MessageId, ChatMsgEvent)
