...
chatCommandP =
  A.choice
    [ "/mute " *> ((`ShowMessages` False) <$> chatNameP'),
      ...
      "/_create_link #" *> (APICreateGroupLink <$> A.decimal),
      "/_delete_link #" *> (APIDeleteGroupLink <$> A.decimal),
      "/_get_link #" *> (APIGetGroupLink <$> A.decimal),
      "/create_link #" *> (CreateGroupLink <$> displayName),
      "/delete_link #" *> (DeleteGroupLink <$> displayName),
      "/show_link #" *> (ShowGroupLink <$> displayName),
