          ...
          case ci of
            Nothing -> do
              ...
              case mapMaybe fileDescrURI rfds of
                [] -> case rfds of
                  rfd@(FD.ValidFileDescription FD.FileDescription {redirect = Nothing}) : _ -> xftpSndFileRedirect user fileId rfd fileInfo >>= toView . CRSndFileRedirectStartXFTP user ft
                  [] -> do
