...
data ChatResponse
  ...
  | CRContactUpdated {fromContact :: Contact, toContact :: Contact, preferences :: PreferencesEnabled}
  ...
  | CRContactPrefsUpdated {fromContact :: Contact, toContact :: Contact, preferences :: PreferencesEnabled}
