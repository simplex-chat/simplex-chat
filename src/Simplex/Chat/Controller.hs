...
data ChatResponse
  ...
  | CRRcvFileStart {user :: User, chatItem :: AChatItem, rcvFileTransfer :: RcvFileTransfer} -- sent by chats
  ...
  | CRSndFileStartXFTP {user :: User, chatItem_ :: Maybe AChatItem, fileTransferMeta :: FileTransferMeta} -- not used
