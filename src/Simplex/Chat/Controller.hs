...
data ChatCommand
  ...
  | APISetConnectionUserId Int64 UserId -- new user id to switch connection to
...
data ChatResponse
  ...
  | CRConnectionUserIdUpdated {user :: User, toConnection :: PendingContactConnection, newUser :: User}
