  ...
  ChatOpts
    ...
    <*> option
      ...
      ( long "server"
          <> short 's'
          <> metavar "SERVER"
          <> help "SMP server(s) to use (smp2.simplex.im#z5W2QLQ1Br3Yd6CoWg7bIq1bHdwK7Y8bEiEXBs/WfAg=)"
          <> value (L.fromList ["smp2.simplex.im#z5W2QLQ1Br3Yd6CoWg7bIq1bHdwK7Y8bEiEXBs/WfAg="])
      )
  where
