...
namesHelpInfo =
  map
    ...
    [ green "Buying a name:",
      ...
      indent <> highlight "/name keys use <n> [<account> [<name>]]",
      indent <> indent <> " - which key the next purchase goes under; after importing a",
      indent <> indent <> "   phrase, also which account this profile is and where its",
      indent <> indent <> "   next name sits, neither of which the phrase records",
