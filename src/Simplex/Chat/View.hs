...
viewContactInfo ct@Contact {contactId, profile = LocalProfile {localAlias, contactLink}, activeConn = Connection {connLevel}} stats incognitoProfile =
