...
data RcvGroupEvent
  ...
  | RGEMemberUpdatedProfile {fromProfile :: Profile, toProfile :: Profile} -- CRGroupMemberUpdated
  deriving (Show)
...
data RcvDirectEvent
  = RDEContactDeleted
  | RDEUpdatedProfile {fromProfile :: Profile, toProfile :: Profile} -- CRContactUpdated
  deriving (Show)
