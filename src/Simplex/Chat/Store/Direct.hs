      ...
      DB.query
        ...
        [sql|
          SELECT
            ...
            ct.contact_group_member_id, ct.contact_grp_inv_sent, ct.contact_grp_inv_link, ct.contact_grp_inv_from_group_id, ct.contact_grp_inv_from_group_member_id, ct.ui_themes, ct.chat_deleted, ct.custom_data, ct.chat_item_ttl,
            -- Connection
