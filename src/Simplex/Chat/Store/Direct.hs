...
createAcceptedContact :: DB.Connection -> User -> ConnId -> JSONVRange -> ContactName -> ProfileId -> Profile -> Int64 -> Maybe XContactId -> Maybe IncognitoProfile -> SubscriptionMode -> IO Contact
