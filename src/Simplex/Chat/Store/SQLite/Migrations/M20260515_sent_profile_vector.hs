...
module Simplex.Chat.Store.SQLite.Migrations.M20260515_sent_profile_vector where

import Database.SQLite.Simple (Query)
import Database.SQLite.Simple.QQ (sql)

m20260515_sent_profile_vector :: Query
...
down_m20260515_sent_profile_vector :: Query
