...
module Simplex.Chat.Store.SQLite.Migrations.M20260715_signed_history where

import Database.SQLite.Simple (Query)
import Database.SQLite.Simple.QQ (sql)

m20260715_signed_history :: Query
m20260715_signed_history =
  [sql|
...
down_m20260715_signed_history :: Query
down_m20260715_signed_history =
  [sql|
