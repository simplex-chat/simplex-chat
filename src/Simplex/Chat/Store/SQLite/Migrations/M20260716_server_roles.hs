...
module Simplex.Chat.Store.SQLite.Migrations.M20260716_server_roles where

import Database.SQLite.Simple (Query)
import Database.SQLite.Simple.QQ (sql)

m20260716_server_roles :: Query
m20260716_server_roles =
  [sql|
...
down_m20260716_server_roles :: Query
down_m20260716_server_roles =
  [sql|
