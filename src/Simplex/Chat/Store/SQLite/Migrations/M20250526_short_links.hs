...
m20250526_short_links =
  [sql|
ALTER TABLE contacts ADD COLUMN inv_conn_req_to_connect BLOB;
ALTER TABLE contacts ADD COLUMN addr_conn_req_to_connect BLOB;
...
down_m20250526_short_links =
  [sql|
ALTER TABLE contacts DROP COLUMN inv_conn_req_to_connect;
ALTER TABLE contacts DROP COLUMN addr_conn_req_to_connect;
