...
module Simplex.Chat.Store.SQLite.Migrations.M20260530_public_group_access where

import Database.SQLite.Simple (Query)
import Database.SQLite.Simple.QQ (sql)

m20260530_public_group_access :: Query
...
down_m20260530_public_group_access :: Query
