...
import Simplex.Chat.Store.SQLite.Migrations.M20250123_indexes_groups_deleted
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20250123_indexes_groups_deleted", m20250123_indexes_groups_deleted, Just down_m20250123_indexes_groups_deleted)
  ]
