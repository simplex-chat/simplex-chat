...
import Simplex.Chat.Store.SQLite.Migrations.M20250813_forwarding_jobs
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20250813_forwarding_jobs", m20250813_forwarding_jobs, Just down_m20250813_forwarding_jobs)
  ]
