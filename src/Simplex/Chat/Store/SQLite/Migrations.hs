...
import Simplex.Chat.Store.SQLite.Migrations.M20250922_remove_contact_merge
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20250922_remove_contact_merge", m20250922_remove_contact_merge, Just down_m20250922_remove_contact_merge)
  ]
