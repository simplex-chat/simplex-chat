...
import Simplex.Chat.Store.SQLite.Migrations.M20250813_forwarding_tasks
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20250813_forwarding_tasks", m20250813_forwarding_tasks, Just down_m20250813_forwarding_tasks)
  ]
