...
import Simplex.Chat.Store.SQLite.Migrations.M20251007_subscriptions_sync
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20251007_subscriptions_sync", m20251007_subscriptions_sync, Just down_m20251007_subscriptions_sync)
  ]
