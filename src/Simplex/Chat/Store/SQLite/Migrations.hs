...
import Simplex.Chat.Store.SQLite.Migrations.M20260201_client_services
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20260201_client_services", m20260201_client_services, Just down_m20260201_client_services)
  ]
