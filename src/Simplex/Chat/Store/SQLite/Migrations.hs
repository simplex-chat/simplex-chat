...
import Simplex.Chat.Store.SQLite.Migrations.M20250730_chat_peer_type
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20250730_chat_peer_type", m20250730_chat_peer_type, Just down_m20250730_chat_peer_type)
  ]
