...
import Simplex.Chat.Store.SQLite.Migrations.M20260715_signed_history
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20260715_signed_history", m20260715_signed_history, Just down_m20260715_signed_history)
  ]
