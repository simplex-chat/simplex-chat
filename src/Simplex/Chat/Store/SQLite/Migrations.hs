...
import Simplex.Chat.Store.SQLite.Migrations.M20260913_preferences_json
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20260913_preferences_json", m20260913_preferences_json, Just down_m20260913_preferences_json)
  ]
