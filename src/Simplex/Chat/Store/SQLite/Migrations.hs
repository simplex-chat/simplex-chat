...
import Simplex.Chat.Store.SQLite.Migrations.M20260515_sent_profile_vector
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20260515_sent_profile_vector", m20260515_sent_profile_vector, Just down_m20260515_sent_profile_vector)
  ]
