...
import Simplex.Chat.Store.SQLite.Migrations.M20251231_strict_tables_2
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20251231_strict_tables_2", m20251231_strict_tables_2, Just down_m20251231_strict_tables_2)
  ]
