...
import Simplex.Chat.Store.SQLite.Migrations.M20250123_indexes_group_members_cleanup
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20250123_indexes_group_members_cleanup", m20250123_indexes_group_members_cleanup, Just down_m20250123_indexes_group_members_cleanup)
  ]
