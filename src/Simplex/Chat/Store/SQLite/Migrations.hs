...
import Simplex.Chat.Store.SQLite.Migrations.M20260430_subscriber_body
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20260430_subscriber_body", m20260430_subscriber_body, Just down_m20260430_subscriber_body)
  ]
