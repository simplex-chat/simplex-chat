...
import Simplex.Chat.Migrations.M20231107_remote_controller
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20231107_remote_controller", m20231107_remote_controller, Just down_m20231107_remote_controller)
  ]
