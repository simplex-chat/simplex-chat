...
import Simplex.Chat.Migrations.M20231126_remote_pairing_pin
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20231126_remote_pairing_pin", m20231126_remote_pairing_pin, Just down_20231126_remote_pairing_pin)
  ]
