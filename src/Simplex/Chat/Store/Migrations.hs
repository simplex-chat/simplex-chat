...
import Simplex.Chat.Migrations.M20240426_rcv_files_user_approved_relays
...
schemaMigrations =
  [ ("20220101_initial", m20220101_initial, Nothing),
    ...
    ("20240426_rcv_files_user_approved_relays", m20240426_rcv_files_user_approved_relays, Just down_m20240426_rcv_files_user_approved_relays)
  ]
