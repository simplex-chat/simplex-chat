        ...
        <$> DB.queryNamed
          ...
          [sql|
            SELECT i.chat_item_id,
              ...
              m.member_status, m.show_messages, m.blocked_by_admin, m.invited_by, m.invited_by_group_member_id, m.local_display_name, m.contact_id, m.contact_profile_id, p.contact_profile_id,
      ...
      DB.query
        ...
        [sql|
          SELECT
            ...
            rm.member_status, rm.show_messages, rm.blocked_by_admin, rm.invited_by, rm.invited_by_group_member_id, rm.local_display_name, rm.contact_id, rm.contact_profile_id, rp.contact_profile_id,
            ...
            dbm.member_status, dbm.show_messages, dbm.blocked_by_admin, dbm.invited_by, dbm.invited_by_group_member_id, dbm.local_display_name, dbm.contact_id, dbm.contact_profile_id, dbp.contact_profile_id,
