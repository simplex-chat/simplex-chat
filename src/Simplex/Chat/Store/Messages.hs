      ...
      DB.query
        ...
        [sql|
          SELECT
            ...
            dbm.support_chat_ts, dbm.support_chat_items_unread, dbm.support_chat_items_member_attention, dbm.support_chat_items_mentions, dbm.support_chat_last_msg_from_member_ts, dbm.member_pub_key, dbm.user_member_key_status, dbm.user_member_key_attempts, dbm.relay_link, dbm.member_security_code, dbm.member_security_code_verified_at
          FROM chat_items i
          LEFT JOIN files f ON f.chat_item_id = i.chat_item_id
