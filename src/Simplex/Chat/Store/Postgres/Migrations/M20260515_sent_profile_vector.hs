...
module Simplex.Chat.Store.Postgres.Migrations.M20260515_sent_profile_vector where

import Data.Text (Text)
import Text.RawString.QQ (r)

m20260515_sent_profile_vector :: Text
m20260515_sent_profile_vector =
  [r|
...
down_m20260515_sent_profile_vector :: Text
down_m20260515_sent_profile_vector =
  [r|
