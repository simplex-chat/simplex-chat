...
Session’s decision was based on [the incorrect statements](https://getsession.org/blog/session-protocol-explained) about double ratchet being impossible in decentralized networks, and underplayed importance of forward secrecy, break-in recovery and deniability - the absence of these qualities all that make Session a much weaker choice for private messaging. For transparency, this was something that was debated with their team [here](https://twitter.com/SimpleXChat/status/1755216356159414602). We also made [a separate post](./20240314-simplex-chat-v5-6-quantum-resistance-signal-double-ratchet-algorithm.md#end-to-end-encryption-security-attacks-and-defense) about these qualities of end-to-end encryption and their presence in different messengers.
...
The first common myth is about the the Online Safety Act (OSA) - some people believe that it applies to the UK companies. It is simply incorrect - the OSA applicability isn't determined by the jurisdiction of a company. The OSA applies based on the nature and characteristics of the business and its services, as well as the number of its users in the UK. In case of SimpleX network, the OSA doesn't apply for both of these reasons.

Another myth is about the UK position on communication encryption. The UK is also not anti-encryption. For example, it didn't attempt to ban the encryption; the legislative intent was to propose technical measures to block CSAM. As the discussion about the bill progressed, the parliament amended the bill, and the government publicly committed to not request the implementation of client-side scanning until a viable technology emerges that wouldn't compromise e2e encryption (which at this point appears to be a wishful thinking). The process's intentions and outcome don't look like an attempt to prohibit encryption. This may have been the desire of lobbyists, like certain anti-privacy non-profits, but it wasn't the aim of the UK government per their own communications on the matter. 
